...
DWORD WINAPI BGI__ThreadInitWindow( LPVOID pThreadData )
{
    ...
    pWndData->WindowStyles = pWndData->title.size( ) ? (WS_CAPTION | WS_SYSMENU | WS_MINIMIZEBOX | WS_DLGFRAME) : (WS_POPUP|WS_DLGFRAME);
    ...
    hWindow = CreateWindowEx( 0,  // Extended window styles
                              ...
                              pWndData->WindowStyles,     // Window styles
    ...
    SetWindowLong( hWindow, GWLP_USERDATA, (LONGLONG)pWndData );
