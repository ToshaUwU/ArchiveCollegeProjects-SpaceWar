...
struct WindowData
{
    ...
    bool FullScreen;            // Window in fullscreen?
    bool HiRes;                 // True make some drawing operations smoother
    DWORD WindowStyles;         // For making window back to window mode from fullscreen
